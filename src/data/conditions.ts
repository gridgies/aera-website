...
export const CONDITIONS_DATA: Record<string, Condition> = {
  ...
  hormone: {
    ...
    relatedConditions: ["menopause", "hashimoto", "schilddruese", "pcos"],
  },
  pcos: {
    slug: "pcos",
    name: "PCOS",
    nameLong: "Polyzystisches Ovarialsyndrom (PCOS)",
    topicName: "PCOS",
    metaTitle: "PCOS Symptome: Polyzystisches Ovarialsyndrom erkennen & behandeln (2026)",
    ctaQuestion: "Leidest du unter PCOS-Symptomen?",
    aliases: [
    ...
    metaDescription:
      "PCOS Symptome erkennen: Unregelmäßiger Zyklus, Akne, Haarausfall, Gewichtszunahme und Müdigkeit bei PCO-Syndrom. Diagnose, Behandlung und Ernährung.",
    symptoms: [
      "akne",
      "gewichtszunahme",
      "haarausfall",
    ...
    relatedConditions: ["hormone", "hashimoto", "menopause"],
  },
};
