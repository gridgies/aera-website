      ...
      <section className="relative px-6 py-16 md:py-32 max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center pt-32 md:pt-40">
        ...
        <div className="relative order-1 md:order-2 h-[400px] md:h-[700px] rounded-[3rem] overflow-hidden shadow-2xl">
          ...
          <img
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDn76Mslg8j3mTZfcfDQROTNrTWZmX1Hgbnb6Cs80R5BqnTGcnzYIJMz7K8NcOFz9G_1Ev6_h4oOooWa4S7LV5RRO3awhW43i4h4pvqt_YZ2xvpA59QqmZmIpz7s8u4c-GU76CCkp2D0iPbVUS8eIaKTDVVP_31ogLN9U8cfHPHY6vVQa6Cl-gajnqA0N2G-xXVYlygAhvNeZWkdIlYK4T8sSNRpg_eMBP5GYcNS0hFts3VtSYBjvdpxmwRcytMIwsm6V7QXot4y1Sj"
          />
